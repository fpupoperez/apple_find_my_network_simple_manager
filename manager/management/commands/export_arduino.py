"""Export the Arduino-IDE ``tag.ino`` sketch for a device from the CLI."""
...
from manager import arduino
from manager.models import Device


class Command(BaseCommand):
    help = "Print (or save) the Arduino-IDE tag.ino sketch for a device."
