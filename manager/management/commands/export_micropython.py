"""Export the generated Micropython ``main.py`` for a device from the CLI."""
...
class Command(BaseCommand):
    help = "Print (or save) the Micropython main.py for a device."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--broadcast", type=int, help="Override broadcast duration (seconds).")
        parser.add_argument("--sleep", type=int, help="Override deep sleep duration (minutes).")
